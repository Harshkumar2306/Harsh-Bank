    ...
    <ClerkProvider
      appearance={({
        ...
        elements: {
          ...
          socialButtonsBlockButton: "!bg-white !text-slate-900 border border-slate-200 hover:!bg-slate-100 transition-all",
          socialButtonsBlockButtonText: "!text-slate-900 font-bold",
          profileSectionPrimaryButton: "!bg-white !text-slate-900 hover:!bg-slate-100",
